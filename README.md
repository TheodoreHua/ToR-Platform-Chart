...
|Post and Comments ![Youtube Post](res/youtube/post_comments.jpeg)<br/>Comments ![Youtube](res/youtube/comment.png)|Youtube|When you see a play button, and the video progress bar is red, chances are you're in youtube. Most youtube posts are posted with comments. The rules for the comments are: Either Black or White Background. Every comment has a profile picture and a username. There are like/dislike buttons. The number of points the comment has is displayed between this buttons.  |  No official template yet. [Use generic social media](https://www.reddit.com/r/TranscribersOfReddit/wiki/formats/images/other)
