...
|Profile ![Linkedin Profile](res/linkedin/linkedin_profile.png)<br/>Job Advert ![Job Advert](res/linkedin/linkedin_job_advert)<br/>Post ![Post](res/linkedin/linkedin_post.jpg)|LinkedIn|All linkedin posts, and profiles, have usernames, and profile pictures. The most important characteristic is that all linkedin profiles have their position under their name. Every post has reactions, similar to facebook (see bottom of image 3), but with different iccons (a lightbulb for example). Most job adverts are in linkedin. If you see the word "Connections", it is Linkedin.
